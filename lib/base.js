...
function Base(quiubas, extend) {
  ...
  this.get = function( /* dynamic */ ) {
    var params = this.parseBaseParams(arguments);
    return this.quiubas.network.get([this.action_name, {
      'id': params.id
    }], params.params, params.success, params.error);
  };

  this.delete = function( /* dynamic */ ) {
    var params = this.parseBaseParams(arguments);
    return this.quiubas.network.delete([this.action_name, {
      'id': params.id
    }], params.params, params.success, params.error);
  };
  ...
  this.update = function( /* dynamic */ ) {
    var params = this.parseBaseParams(arguments);
    return this.quiubas.network.put([this.action_name, {
      'id': params.id
    }], params.params, params.success, params.error);
  };
